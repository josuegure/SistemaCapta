 ...
 * @author josue
 */
public class InicioParamedicoController implements Initializable {
@FXML
    ...
    private Button btnIniciarSesion;
        @FXML
    private Button btnIniciarSesionParame;
    private validadoperador loginService;

    public InicioParamedicoController() {
    ...
    private void iniciarSesion() {
        ...
        if (validarOperador(numTrabajador, contrasenia)) {
            ...
            mostrarError("Número de parámedico o contraseña incorrectos.");
        }
    }
    private boolean validarOperador(String numTrabajador, String contrasenia) {
        String query = "SELECT * FROM paramedicos WHERE Num_trabajador_Par = ? AND contrasenia = ?";
    ...
    private void mostrarMensajeBienvenida(String numTrabajador) {
        FunctionsOfClasses.showAlertGood(Alert.AlertType.INFORMATION, "Inicio exitoso", "Bienvenido paramédico #" + numTrabajador + "!");
    }
